...
const AdminView: React.FC<AdminViewProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-amber-50 flex text-gray-900">
      {/* Sidebar - Desktop */}
      <aside className="w-64 bg-white border-r border-amber-100 hidden md:flex flex-col fixed h-full z-10">
        <div className="p-6">
      ...
      {/* Mobile Header */}
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white p-4 shadow-sm z-20 flex justify-between items-center">
      ...
      {/* Main Content */}
      <main className="flex-1 md:ml-64 p-6 mt-14 md:mt-0 overflow-y-auto">
